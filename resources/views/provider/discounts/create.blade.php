    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Tambah Diskon</h1>
                    <p class="mt-2 text-gray-600">Buat diskon baru untuk tempat tinggal atau kegiatan Anda.</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <form action="{{ route('provider.discounts.store') }}" method="POST" class="p-6">
                @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="discountable_type" id="discountable_type"
                                ...
                                <option value="App\Models\Residence" {{ old('discountable_type') == 'App\Models\Residence' ? 'selected' : '' }}>
                                    Tempat Tinggal
                                </option>
                                <option value="App\Models\Activity" {{ old('discountable_type') == 'App\Models\Activity' ? 'selected' : '' }}>
                                    Kegiatan
                                </option>
                            </select>
                        ...
                        <div>
                            ...
                            <div class="mt-2 space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                                <div class="flex items-center">
                                    <input type="radio" name="is_percentage" value="0" {{ old('is_percentage') == '0' ? 'checked' : '' }}
                                ...
                                <div class="flex items-center">
                                    <input type="radio" name="is_percentage" value="1" {{ old('is_percentage') == '1' ? 'checked' : '' }}
                                        class="focus:ring-purple-500 h-4 w-4 text-purple-600 border-gray-300">
                                    <label class="ml-3 block text-sm font-medium text-gray-700">
                                        Persentase
                                    </label>
                ...
                fetch(`/provider/discounts/get-items?type=${type}`)
                    ...
                    .then(data => {
                        data.forEach(item => {
                            ...
                            if (item.id == '{{ old('discountable_id') }}') {
