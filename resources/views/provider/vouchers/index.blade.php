                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-500">Max: Rp
                                {{ number_format($voucher->max_discount, 0, ',', '.') }}</div>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2 mt-1">
                                <div class="bg-blue-600 h-2 rounded-full" style="width: {{ (float) $percentage }}%">
                                </div>
                            </div>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-gray-400">Deactivate</span>
                                <span class="text-gray-400">Hapus</span>
                                @else
                                <a href="{{ route('provider.vouchers.edit', $voucher) }}"
                                    class="text-blue-600 hover:text-blue-900">Edit</a>

                                <form action="{{ route('provider.vouchers.toggle-status', $voucher) }}" method="POST"
                                    class="inline">
                                    @csrf
                                    @method('PATCH')
                                    <button type="submit"
                                ...
                                <form action="{{ route('provider.vouchers.destroy', $voucher) }}" method="POST"
                                    class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
