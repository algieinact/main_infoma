...
<div class="bg-gray-100 min-h-screen py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Kelola booking dan aktivitas Anda di sini.</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-gray-600 text-sm">Total Bookings</h2>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-gray-600 text-sm">Menunggu Persetujuan</h2>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <h2 class="text-gray-600 text-sm">Ditolak</h2>
                        <p class="text-2xl font-semibold text-gray-900">
