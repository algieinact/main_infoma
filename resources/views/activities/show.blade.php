                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                                ...
                                @foreach($activity->reviews as $review)
                                    <div class="border-b pb-4">
                                        <div class="flex items-center mb-2">
                                            ...
                                            <span class="ml-2 text-gray-600 text-xs">{{ $review->created_at->diffForHumans() }}</span>
                                        </div>
                        ...
                        <form action="{{ route('reviews.store') }}" method="POST" class="space-y-4">
                            @csrf
                            <input type="hidden" name="reviewable_type" value="App\\Models\\Activity">
                            <input type="hidden" name="reviewable_id" value="{{ $activity->id }}">
                            <div>
                                <label for="rating" class="block text-sm font-medium text-gray-700">Rating</label>
                                <select name="rating" id="rating" class="mt-1 block w-24 border-gray-300 rounded-md shadow-sm">
                            ...
                            <div>
                                ...
                                <textarea name="comment" id="comment" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                            </div>
                            <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:bg-blue-700 transition">Submit Review</button>
                        </form>
                        @endauth
                    </div>
                </div>
                        ...
                        @if($activeVoucher)
                            <div class="mt-2">
                                ...
                                <div class="text-sm text-gray-600 mt-1">
                                    Gunakan kode: <span class="font-semibold">{{ $activeVoucher->code }}</span>
                                </div>
                            </div>
                        @endif
                    </div>
