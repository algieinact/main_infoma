...
@section('title', 'Temukan Tempat Tinggal')

@section('content')
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <!-- Search and Filter Section -->
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <form action="{{ route('residences.index') }}" method="GET" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select name="type" id="type"
                        ...
                        <option value="kost" {{ request('type') == 'kost' ? 'selected' : '' }}>Kost</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
            <a href="{{ route('residences.show', $residence->slug) }}" class="block">
                <div class="relative h-48">
                    <img src="{{ $residence->first_image ?? asset('images/placeholder.jpg') }}"
                        alt="{{ $residence->title }}"
                ...
                <div class="p-4">
                    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $residence->title }}</h3>
